...
int print_n_hex(va_list args, char *buf, unsigned int ibuf);
int print_n_oct(va_list args, char *buf, unsigned int ibuf);
int print_s_hex(va_list args, char *buf, unsigned int ibuf);
